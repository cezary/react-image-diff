...
/***/ function(module, exports, __webpack_require__) {
	...
	function diffImages(beforeUrl, afterUrl) {
	  return Promise.all([fetchContext(beforeUrl), fetchContext(afterUrl)]).then(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 2);

	    var beforeCtx = _ref2[0];
	    var afterCtx = _ref2[1];
	  ...
	  _createClass(ImageDiff, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      if (this.props.type === 'difference') {
	        diffImages(this.props.before, this.props.after).then(function (beforeCtx) {
	          _this.setState({
	            ctx: beforeCtx
	          });
	        });
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.type !== 'difference') {
	        ...
	        diffImages(nextProps.before, nextProps.after).then(function (beforeCtx) {
	          _this2.setState({
	            ctx: beforeCtx
	          });
	        });
	    ...
	    value: function handleImgLoad(ref) {
	      ...
	      return function () {
	        if (!_this3.props.height && !_this3.props.width) {
	          var _React$findDOMNode = _react2['default'].findDOMNode(_this3.refs[ref]);
	    ...
	    value: function renderDifference() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'ImageDiff_inner--difference' },
...
/***/ function(module, exports) {
	...
	(function () {
		...
		addBlendMethod(CanvasRenderingContext2D && CanvasRenderingContext2D.prototype);
		...
		function blendOnto(destContext, blendMode, offsetOptions) {
			...
			var sA,
			    dA,
			    len = dst.length;
			var sRA, sGA, sBA, dRA, dGA, dBA, dA2, r1, g1, b1, r2, g2, b2;
			var demultiply;
	   ...
	   */
				var b2 = b << 1;
				if (b < 128) return a * (b2 + (a * (255 - b2) >> 8)) >> 8;else return a * (511 - b2) + Math.sqrt(a << 8) * (b2 - 255) >> 8;
			}

			function Foverlay(a, b) {
				return a < 128 ? a * b >> 7 : // (2*a*b)>>8 :
				255 - ((255 - b) * (255 - a) >> 7);
			}
	  ...
	  */
			...
			for (var px = 0; px < len; px += 4) {
				...
				switch (blendMode) {
					...
					default:
						// ******* UNSUPPORTED mode, produces yellow/magenta checkerboard
